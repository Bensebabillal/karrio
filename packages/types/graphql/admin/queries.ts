...
export const GET_SYSTEM_USAGE = gql`query GetSystemUsage($filter: UsageFilter) {
...
export const GET_SURCHARGES = gql`query GetSurcharges($filter: SurchargeFilter) {
...
export const GET_SURCHARGE = gql`query GetSurcharge($id: String!) {
  surcharge(id: $id) {
    object_type
    id
    name
...
export const CREATE_USER = gql`mutation CreateUser($data: CreateUserMutationInput!) {
...
export const UPDATE_USER = gql`mutation UpdateUser($data: UpdateUserMutationInput!) {
...
export const REMOVE_USER = gql`mutation RemoveUser($data: DeleteUserMutationInput!) {
...
export const CREATE_SURCHARGE = gql`mutation CreateSurcharge($data: CreateSurchargeMutationInput!) {
...
export const UPDATE_SURCHARGE = gql`mutation UpdateSurcharge($data: UpdateSurchargeMutationInput!) {
...
export const UPDATE_ORGANIZATION_ACCOUNT = gql`mutation UpdateOrganizationAccount($data: UpdateOrganizationAccountMutationInput!) {
